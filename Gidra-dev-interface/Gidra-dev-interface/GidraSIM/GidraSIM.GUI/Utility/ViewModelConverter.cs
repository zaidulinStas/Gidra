...
namespace GidraSIM.GUI.Utility
{
    public class ViewModelConverter : IViewModelConverter
    {
        ...
        {
            //Dictionary<ProcedureWPF, BaseProcedure> procedures = new Dictionary<ProcedureWPF, BaseProcedure>();
        ...
        private Resource ConvertWpfResourcekToModel(ResourceWPF resourceWPF)
        {
            if (resourceWPF == null)
