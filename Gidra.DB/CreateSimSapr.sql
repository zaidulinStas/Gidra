...
AS
BEGIN
    INSERT Resources.CPU(QuantityCore,Frequency,Price)
    VALUES (@QuantityCore,@Frequency,@Price);
...
AS
BEGIN
    INSERT Resources.InformationSupports (MultiClientUse,Type,Price)
    VALUES (@MultiClientUse,@Type,@Price)
    SELECT scope_identity()
END
GO
...
AS
BEGIN
    SELECT * FROM Resources.InformationSupports
END
GO
...
AS
BEGIN
    INSERT Resources.Softwares(Type,Name,LicenseForm,LicenseStatus,Price)
    VALUES (@Type,@Name,@LicenseForm,@LicenseStatus,@Price)
    SELECT scope_identity()
END
GO
...
AS
BEGIN
    SELECT * FROM Resources.Softwares
END
GO
...
AS
BEGIN
    INSERT Resources.Monitors(Diagonal,Price)
...
AS
BEGIN
    select * FROM Resources.Monitors
END
GO
...
AS
BEGIN
    INSERT Resources.StorageDevices(SpeedWrite,SpeedRead,Size,Price)
    VALUES (@SpeedWrite,@SpeedRead,@Size,@Price)
    SELECT scope_identity()
END
GO
...
AS
BEGIN
    SELECT * FROM Resources.StorageDevices
END
GO
...
AS
BEGIN
    INSERT Resources.Printers(Type,Speed,Price)
    VALUES (@Type,@Speed,@Price)
    SELECT scope_identity()
END
GO
...
AS
BEGIN
    SELECT * FROM Resources.Printers
END
GO
...
AS
BEGIN
    INSERT Resources.InputDevices(Type,Price)
    VALUES (@Type,@Price)
    SELECT scope_identity()
END
GO
...
AS
BEGIN
    SELECT * FROM Resources.InputDevices
END
GO
...
AS
BEGIN
    INSERT Resources.RAM(Size,Frequency,Price)
